...
/* Este código muestra texto en la pantalla OLED SSD1306. En primer lugar, imprime algunas cadenas y 
 * luego muestra el valor del contador de 0 a 100
*/
...
void I2C3_Init (void) //inicialización I2C y configuración GPIO
{
    SYSCTL->RCGCGPIO  |= 0x00000008 ; //habilitar reloj de GPIO puerto D (la OLED se conecta a PD0 y PD1)
    SYSCTL->RCGCI2C   |= 0x00000008 ; // habilitar reloj para I2C 3
    GPIOD->DEN |= 0x03; //habilitar pones digitales
    // Configure Port D pins 0 and 1 as I2C 3
    GPIOD->AFSEL |= 0x00000003 ; //funciones alternativas
    GPIOD->PCTL |= 0x00000033 ; //indicar función alternativa
